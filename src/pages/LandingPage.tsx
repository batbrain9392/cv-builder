      ...
      <div className="grid gap-5 lg:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-xs text-muted-foreground">
            ...
            <p>
              No ad or marketing cookies. The live site may load{' '}
              <strong>Cloudflare Web Analytics</strong> (cookieless aggregate traffic only; no
              personal identifiers or cross-site ad tracking). The Sentry SDK may still use browser
              storage for its own session correlation.
            </p>
            <p>
